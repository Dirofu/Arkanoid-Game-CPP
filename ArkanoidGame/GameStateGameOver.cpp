...
namespace ArkanoidGame
{
	...
	void GameStateGameOverData::InitGameState()
	{
		...
		int snakeScores = game.GetRecords(PLAYER_NAME);
		for (const auto& item : game.GetRecords())
		{
	...
	void GameStateGameOverData::ShutdownGameState()
	{
		// We dont need to free resources here, because they will be freed automatically
	}

	void GameStateGameOverData::HandleGameStateWindowEvent(const sf::Event& event)
	{
		Game& game = Application::Instance().GetGame();
	...
	void GameStateGameOverData::UpdateGameState(float timeDelta)
	{
	...
	void GameStateGameOverData::DrawGameState(sf::RenderWindow& window)
	{
