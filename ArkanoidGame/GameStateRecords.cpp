...
{
	void GameStateRecordsData::InitGameState()
	{
	...
	void GameStateRecordsData::ShutdownGameState()
	{
		// Nothing to clear here
	}

	void GameStateRecordsData::HandleGameStateWindowEvent(const sf::Event& event)
	{
		Game& game = Application::Instance().GetGame();
	...
	void GameStateRecordsData::UpdateGameState(float timeDelta)
	{

	}

	void GameStateRecordsData::DrawGameState(sf::RenderWindow& window)
	{
